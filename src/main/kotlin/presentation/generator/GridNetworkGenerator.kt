    ...
    private fun initialConnectNodesInRepresentation(set: MarkedSet<LocallyCoordinatedModelNode>){
       for (modelNode in set){
           ...
           if (modelNode.right != null){
               ...
               val destinationPos =
                       toFixedNode.getOppositeConnectionCoordinte(if (toFixedNode == rep) Port.RIGHT else anotherPort)
           ...
           if (modelNode.left != null){
               ...
               updateRotationInBatch(toMoveNode,degreeOfTransfer)
               val destinationPos =
                       toFixedNode.getOppositeConnectionCoordinte(if (toFixedNode == rep) Port.LEFT else anotherPort)
               movePosInBatch(toMoveNode,destinationPos)
           ...
           if (modelNode.up != null){
               ...
               updateRotationInBatch(toMoveNode,degreeOfTransfer)
               val destinationPos =
                       toFixedNode.getOppositeConnectionCoordinte(if (toFixedNode == rep) Port.UP else anotherPort)
               movePosInBatch(toMoveNode,destinationPos)
           }
           if(modelNode.down != null){
               ...
               updateRotationInBatch(toMoveNode,degreeOfTransfer)
               val destinationPos =
                       toFixedNode.getOppositeConnectionCoordinte(if (toFixedNode == rep) Port.DOWN else anotherPort)
               movePosInBatch(toMoveNode,destinationPos)
           }
       }
    }
